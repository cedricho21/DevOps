...
public class GatewayController {
    ...
    private Counter gatewayRequestsCounter = Counter.builder("gateway.requests.received").description("Количество полученных запросов на gateway").register(Metrics.globalRegistry);
