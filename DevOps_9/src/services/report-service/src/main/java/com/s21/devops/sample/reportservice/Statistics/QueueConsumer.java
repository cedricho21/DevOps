...
public class QueueConsumer {
    ...
    private Counter processedMessagesCounter = Counter.builder("rabbitmq.messages.processed").description("Количество обработанных сообщений в RabbitMQ").register(Metrics.globalRegistry);
