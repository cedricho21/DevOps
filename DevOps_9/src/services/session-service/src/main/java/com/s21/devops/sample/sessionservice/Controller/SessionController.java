...
public class SessionController {
    ...
    private Counter authCounter = Counter.builder("auth.request").description("Количество полученных запросов на авторизацию пользователей").register(Metrics.globalRegistry);
